...
import static com.ericsson.eniq.taf.db.Constants.DEFAULT_JAVA_DATE_FORMAT_STRING;
import static com.ericsson.eniq.taf.db.Constants.MT_DATE_FORMAT_STRING;
...
import com.ericsson.eniq.taf.db.Constants;
...
public final class DateTimeUtil {
     ...
     * @throws  
     */
    public static long measureTimeBetweenTwoEventsFromLog(final String startLogLine, final String endLogLine) throws DBHandlerException {
     ...
     * @throws DBHandlerException 
     */
    public static long getAmountOfSecondsToMeasure(final Date startTime, final Date endTime) throws DBHandlerException {
        ...
        if (!endTimeLaterFlag) {
            throw new DBHandlerException("ERROR: Start time must be before end time");
        }
     ...
     * @throws DBHandlerException 
     */
    public static long getAmountOfSecondsToMeasure(final String startTime, final String endTime) throws DBHandlerException {
    ...
    /**
     * gets start time in format {@link com.ericsson.eniq.taf.db.oss.testware.ddcoperator.utils.Constants#MT_DATE_FORMAT_STRING}.
     *
     * @return startTime
     */
    ...
    public static String getEndTimeHandleNull(final String lastDataAvailableInDdpTime) {
        ...
        if (endTime == null) {
            ...
            endTime = DateTimeUtil.convertDateStringFromOneFormatToAnother(lastDataAvailableInDdpTime, MT_DATE_FORMAT_STRING);
     ...
     * {@link com.ericsson.eniq.taf.db.oss.testware.ddcoperator.utils.Constants#DEFAULT_JAVA_DATE_FORMAT_STRING}
     *
     * @param dateString
     *         string to convert
     * @param otherFormat

 ...
 *
 */
public class MonitorHeapScriptOperator extends CLIOperator {
	...
	Logger logger = LoggerFactory.getLogger(MonitorHeapScriptOperator.class);

	public MonitorHeapScriptOperator() {

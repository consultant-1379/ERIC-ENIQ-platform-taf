 ...
 *
 */
public class RHELOSScriptsMaintenanceOperator extends CLIOperator {
	...
	Logger logger = LoggerFactory.getLogger(RHELOSScriptsMaintenanceOperator.class);

	public RHELOSScriptsMaintenanceOperator() {

 ...
 *
 */
public class SelfSignedValidityOperators extends CLIOperator {
	...
	Logger logger = LoggerFactory.getLogger(SelfSignedValidityOperators.class);

	public SelfSignedValidityOperators() {

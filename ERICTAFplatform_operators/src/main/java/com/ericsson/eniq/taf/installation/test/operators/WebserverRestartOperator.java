 ...
 *
 */
public class WebserverRestartOperator extends CLIOperator {
	...
	Logger logger = LoggerFactory.getLogger(WebserverRestartOperator.class);

	public WebserverRestartOperator() {
